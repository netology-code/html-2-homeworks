...
15. убедитесь, что результат соответствует описанию. Для этого перейдите в режим FullPage ([скриншот](https://MihailOkatev.github.com/html-2-homeworks/sources/fullPS.png).”

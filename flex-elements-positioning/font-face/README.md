...
## Советы
Psd форматы помимо фотошопа можно открыть любым онлайн редактором, например [фотоэпия](https://www.photopea.com/).
[Работа с текстом](https://www.photopea.com/learn/text-style)
